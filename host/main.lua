 ...
 local event = host:service()
   ...
   if dirX1 == 1 then
        if player.y > player2.y then --if p2 is lower
            if math.abs(player.x - player2.x) <= 100 and math.abs(player2.y - player.y)<=16 and love.keyboard.isDown('space')  then
        ...
        if player.y == player2.y and math.abs(player.x - player2.x) <= 100 and love.keyboard.isDown('space')   then
            hpLine2.width = hpLine2.width + 1
        end 
    end
    ...
    ---
     ...
     if dirX2 == -1 then
        if player2.y > player.y then -- if p2 is lower
            if player2.x - player.x <= 100 and math.abs(player.y - player2.y)<=16 and btn2 == "space" then
                hpLine.width = hpLine.width - 1
            end
        end
        if player2.y < player.y then --if p2 is higher
            if player2.x - player.x <= 100 and math.abs(player2.y - player.y)<=16  and btn2 == "space"  then
                hpLine.width = hpLine.width - 1
            end
        end
        if player2.y == player.y and player2.x - player.x <= 100 and btn2 == "space"   then
            hpLine.width = hpLine.width - 1
        end
    ...
    if dirX2 == 1 then
        if player2.y > player.y then --if p2 is lower
            if player.x - player2.x <= 100 and math.abs(player.y - player2.y)<=16 and btn2 == "space" then
                hpLine.width = hpLine.width - 1
            end
        end
        if player2.y < player.y then--if p2 is higher
